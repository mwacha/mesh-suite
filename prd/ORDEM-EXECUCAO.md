...
| 2 | Cadastro Comercial (Cliente + Produto) | `PRD-13-cadastro-comercial.md` | Subconjunto do PRD-13: só os cadastros-mestre Cliente/Fornecedor e Produto. Pré-requisito de Pedidos — nenhum pedido existe sem cliente e produto para selecionar. Tabela de Preço, Modelo/Ficha Técnica e os cadastros auxiliares de característica (Cor, Tamanho, Estampa, Tecido/Aviamento, Grupo de Produto, Unidade, Origem do Produto) ficam para quando forem necessários, não fazem parte deste recorte inicial. |
